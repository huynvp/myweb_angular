...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskWorkAdminModule", function() { return TaskWorkAdminModule; });
...
/* harmony import */ var _taskworkadmin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./taskworkadmin */ "./src/app/admin/UserAdmin/TaskWork/taskworkadmin.ts");
...
TaskWorkAdminModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _taskworkadmin__WEBPACK_IMPORTED_MODULE_8__["TaskWorkAdminComponent"]
        ]
    })
], TaskWorkAdminModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskWorkAdminComponent", function() { return TaskWorkAdminComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let TaskWorkAdminComponent = class TaskWorkAdminComponent extends src_shread_base_component__WEBPACK_IMPORTED_MODULE_8__["BaseComponent"] {
    ...
    handleAddTaskWork() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.spinner.show();
            yield this.user.addNewTask(this.txtTitleTask, this.txtContentTask, this.txtDateTask, this.txtStatusTaskWork, this.txtTypeTaskWork)
                .then(data => {
    ...
    changeStatusTask(key, status) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.spinner.show();
            yield this.user.showDetailTask(key)
                .then((data) => { var data; return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                data = data["data"];
                yield this.user.changeStatusTask(data["key"], status)
                    .then(data => {
    ...
    handleEditTask() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.spinner.show();
            yield this.user.editTask(this.key, this.txtTitleTask, this.txtContentTask, this.txtDateTask, this.txtStatusTaskWork, this.txtTypeTaskWork)
                .then(data => {
...
TaskWorkAdminComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'task-work-admin',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./taskworkadmin.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/UserAdmin/TaskWork/taskworkadmin.html")).default,
        providers: [
            _useradmin_service__WEBPACK_IMPORTED_MODULE_2__["UserAdminService"]
        ],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./taskworkadmin.component.css */ "./src/app/admin/UserAdmin/TaskWork/taskworkadmin.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"], _useradmin_service__WEBPACK_IMPORTED_MODULE_2__["UserAdminService"], ngx_spinner__WEBPACK_IMPORTED_MODULE_3__["NgxSpinnerService"]])
...
//# sourceMappingURL=UserAdmin-TaskWork-taskworkadmin-module-es2015.js.map