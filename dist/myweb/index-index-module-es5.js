(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["index-index-module"], {
  ...
  function srcAppIndexIndexComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let IndexComponent = class IndexComponent extends _shread_base_component__WEBPACK_IMPORTED_MODULE_7__["BaseComponent"] {
            ...
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.time1 = setInterval(() => {
                  ...
                  this.seconds = Math.floor(distance % (1000 * 60) / 1000); // console.log(this.seconds);
                }, 500);
                _context2.next = 4;
                return this.getCorona();

              case 4:
                this.time2 = setInterval(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
                /*#__PURE__*/
              ...
              case 8:
                this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl, "/user/me"), {
                  ...
                  localStorage.removeItem('access_token'); // console.log(err);
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                this.loading = true;
                _context3.next = 3;
                return this.app.callApiCorona().then(data => {
                  console.log(data);
      ...
      handleChangeEvent(id) {
        this.app.getDetailEvent(id).then(data => {
          this.eventName = data['data']['name'];
          this.eventDate = new Date(data['data']['date']); // console.log(data);
        }).catch(err => {
          console.log(err);
        });
      }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerService"], _app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"]])], IndexComponent);
    /***/
  },
  ...
  function srcAppIndexIndexModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _index_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./index.component */
    "./src/app/index/index.component.ts");
    ...
    IndexModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      declarations: [_index_component__WEBPACK_IMPORTED_MODULE_5__["IndexComponent"]]
    })], IndexModule);
    /***/
  }
}]);
